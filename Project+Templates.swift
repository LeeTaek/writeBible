...
public extension Package {
  static let swinject: Package = .package(url: "https://github.com/realm/realm-cocoa.git", .branch("master") )
  ...
  static let TCACoordinator: Package = .package(url: "https://github.com/johnpatrickmorgan/TCACoordinators", .upToNextMajor(from: "0.4.3"))
}
